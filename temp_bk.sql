...
CREATE DATABASE IF NOT EXISTS `licencias_moda_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `licencias_moda_db`;
...
INSERT INTO `admin_licencias` (`id_admin`, `nombre`, `email`, `password`, `estado`, `fecha_registro`) VALUES
	(1, 'Super Administrador', 'admin@licencias.com', '$2y$10$1fCioUmdGuz83KmS8ltRyeWMcWGpcywBlAuOTvH6m.1vGLd3z5o/K', 1, '2026-03-26 02:52:00');
...
CREATE TABLE IF NOT EXISTS `licencias` (
  ...
  `tipo_periodo` enum('mensual','trimestral','semestral','anual') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'mensual',
